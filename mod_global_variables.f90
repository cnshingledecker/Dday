...
REAL(wp), SAVE                               :: rho, rho_ice, ice_thick, t, tdust, G0_stellar, AvSt, AvIS, ZetaCR, ZetaX, agr, drho, dust2gas, ebed, ebed_factor, sitedens, nsites, nml, nml_old, nml_max, n_s_ml, bulk_diff_slowdown, barrier_tunneling_w, ph_yield, phi_exp,se_exp,DVAL,EXTFAC,ICE_AREA,ION_NU,IONION_NU
...
CHARACTER(LEN=4), DIMENSION(17)              :: radical_names = (/"bO  ","bOH ","bHO2","bHO3","bH  ","bHS ","bNS ","bHSO","bCS ","bO+ ","bO- ","bO2+","bO2-","bO3+","bO3-","be- ","ge- "/)
REAL(wp)                                     :: initial_water, trial_nu, initial_oxygen
REAL(wp)                                     :: total_atoms
