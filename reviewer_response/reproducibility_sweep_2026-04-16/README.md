...
The detailed replay outputs were intentionally pruned from the archival repo
once the resubmission was complete. This directory keeps the provenance note
and the exact replay recipe; the generated `ion-on/` and `ion-off/` products
can be regenerated from a clean clone using the commands below.
